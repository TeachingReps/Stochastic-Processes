...
\lim_{n \in \N}\frac{\sum_{i=1}^nx_i}{n} = \lim_{n \in \N}\frac{m(n)}{n} = c.
\end{equation*}
...
\end{defn}
	Compare this definition with the definition of Riemann integrals. A function $g: [0, M] \rightarrow \R $ is Riemann integrable if 
   \begin{eqnarray*}
...
%Reverse can be proved by approximating a directly Riemann integrable function with simple functions. 
...
\begin{align*}
\lim_{t \rightarrow \infty}\bar{H}(t) &= 0, & \int_0^\infty \bar{H}(t)dt &= E[Z_n].
\end{align*}
