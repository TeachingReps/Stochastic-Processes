...
%%
N=1000;
d = 2; % Size of subset of randomly chosen servers
n_arrivals = 20000;
num_trials = 1;
...
for trial = 1:num_trials
    ...
    for i=1:n_arrivals
        ...
        %disp(i)
        subset_server = randi(N,[1 d]); % changed from randi(N) to 1.
        server_id(i) = subset_server(find(Q(subset_server)==min(Q(subset_server)),1));
