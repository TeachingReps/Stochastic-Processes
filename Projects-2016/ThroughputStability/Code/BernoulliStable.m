% Queue lengths for priority max weight for Bernoulli arrivals.
% Figure 2
...
N = 1000;    % Number of time slots for which the algorithm is run
...
%export_fig Bernoulli_1.pdf -transparent

figure; plot(Q2,'o'); %title('Q2','fontsize',24)
xlabel('Time','fontsize',24)
ylabel('Queue Length','fontsize',24)
%export_fig Bernoulli_2.pdf -transparent
