...
\input{header}
\title{Lecture 09: Branching Processes and Delayed Renewal Process}
\author{}
...
\begin{flalign*}
M(t)&=\mathbb{E}[X(t)] = \mathbb{E}[\mathbb{E}(X(t)|T_1)]\\
&=\int_{0}^{\infty}\mathbb{E}[X(t)|T_1=y]dF(y)\\
On splitting, \\
&=\int_{0}^{t}\mathbb{E}[X(t)|T_1=y]dF(y) + \int_{t}^{\infty}\mathbb{E}[X(t)|T_1=y]dF(y)\\
