...
\begin{exmp}[Queues] Queues are a complex stochastic process and consist of two stochastic processes arrival and service, and the buffer. 
\end{exmp}
\begin{exmp}[Gambler's ruin] 
\end{exmp}
\begin{exmp}[Urn Models]
\end{exmp}
