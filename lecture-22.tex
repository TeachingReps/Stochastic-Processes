...
\begin{prop}
Let $X_n \in [-M,M]\cup \Z$ for some finite $M$, then  random walk $S_n$ with step size $X_n$ is a recurrent DTMC iff $\E X = 0$.
\end{prop}
\begin{proof}
If $\E X \neq 0$, the random walk is clearly transient since, it will diverge to $\pm \infty$ depending on the sign of $\E X$. 
Conversely, if $\E X =0$, then $S_n$ is a martingale. Let 
\begin{align*}A = \{-M, -M+1,\cdots,-2,-1\}\end{align*}
...
\begin{align*}E[S_N] =E[S_0] = i\end{align*}
Thus we have
\begin{flalign}
...
\begin{align*}P[S_N \in A] \geq \frac{j-i}{j+M}\end{align*}
Thus we have 
\begin{align*}P[\mbox{process ever enters }A] \geq P[S_N \in A] \geq \frac{j-i}{j+M}\end{align*}
As $j$ tends to $\infty$, we see
\begin{align*}P[\mbox{process ever enters }A|\mbox{starts at }i ] = 1 \quad i \geq 0\end{align*}

Now let $B = \{1,2,\cdots, M\}$. Repeat the arguments to show
\begin{align*}P[\mbox{process ever enters }B|\mbox{starts at }i ] = 1 \quad i \geq 0\end{align*}

Hence we have
\begin{align*}P[\mbox{process ever enters }A\cup B|\mbox{starts at }i ] = 1 \quad i \geq 0\end{align*}
...
\end{flalign*}
Hence we get, 
\begin{align*}P_A \approx \frac{1-e^{-\theta B}}{e^{\theta A}-e^{\theta B}}\end{align*}
